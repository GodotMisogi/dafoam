...
#include "AdjointJacobianConnectivityInterFoam.H"
...
defineTypeNameAndDebug(AdjointJacobianConnectivityInterFoam, 0);
addToRunTimeSelectionTable(AdjointJacobianConnectivity, AdjointJacobianConnectivityInterFoam, dictionary);

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointJacobianConnectivityInterFoam::AdjointJacobianConnectivityInterFoam
(
    const fvMesh& mesh,
    ...
    AdjointJacobianConnectivity(mesh,adjIO,adjReg,adjRAS,adjIdx)
    {
        ...
        // Adj state connectivity levels for interFoam, numbers denote the level of connectivity
