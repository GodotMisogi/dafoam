...
#include "AdjointSolverRegistryPimpleFoam.H"
...
defineTypeNameAndDebug(AdjointSolverRegistryPimpleFoam, 0);
addToRunTimeSelectionTable(AdjointSolverRegistry, AdjointSolverRegistryPimpleFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

AdjointSolverRegistryPimpleFoam::AdjointSolverRegistryPimpleFoam
(
    const fvMesh& mesh
)
    :
